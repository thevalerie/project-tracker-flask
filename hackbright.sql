...
4	Madlibs	Build a playable Madlib	75
5	Madlibs	Build a playable Madlib	75
6	Madlibs	Create a madlib that allows a user to enter text and displays the result.	75
7	Madlibs	Create a madlib that allows a user to enter text and displays the result.	75
8	Madlibs	Create a madlib that allows a user to enter text and displays the result.	75
9	Madlibs	Create a madlib that allows a user to enter text and displays the result.	75
10	Madlibs	Create a madlib that allows a user to enter text and displays the result.	75
\.
